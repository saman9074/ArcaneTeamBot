...
if (matches[1] == "ping" and is_mod(msg) and not Clang) or (matches[1] == "آنلاینی" and is_mod(msg) and Clang) or (matches[1] == "انلاینی" and is_mod(msg) and Clang) or (matches[1] == "هستی" and is_mod(msg) and Clang) or (matches[1] == "بات" and is_mod(msg) and Clang) then	
   if not lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "*I'm Ok, Thanks.*", 0, "md")
     elseif lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "*آنلاینم و آماده به خدمت...*", 0, "md")
   end
end 
